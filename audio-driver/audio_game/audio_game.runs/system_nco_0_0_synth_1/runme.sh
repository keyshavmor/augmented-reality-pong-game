...
HD_PWD='/home/lina/Dokumente/TUB/SoSe2018/AES/audio_game/audio_game.runs/system_nco_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_nco_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_nco_0_0.tcl
