...
-- Date        : Fri Jun  8 15:52:14 2018
-- Host        : morita running 64-bit Ubuntu 16.04.4 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/lina/Dokumente/TUB/SoSe2018/AES/audio_game/audio_game.srcs/sources_1/bd/system/ip/system_nco_0_0/system_nco_0_0_sim_netlist.vhdl
...
entity system_nco_0_0_nco_AXI4LiteS_if is
  port (
    ...
    q0_reg_1 : in STD_LOGIC_VECTOR ( 15 downto 0 );
  ...
  attribute ORIG_REF_NAME of system_nco_0_0_nco_AXI4LiteS_if : entity is "nco_AXI4LiteS_if";
end system_nco_0_0_nco_AXI4LiteS_if;

architecture STRUCTURE of system_nco_0_0_nco_AXI4LiteS_if is
  ...
  attribute SOFT_HLUTNM of \_step_size_V[0]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \_step_size_V[10]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \_step_size_V[11]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \_step_size_V[12]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \_step_size_V[13]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \_step_size_V[14]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \_step_size_V[15]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \_step_size_V[1]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \_step_size_V[2]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \_step_size_V[3]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \_step_size_V[4]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \_step_size_V[5]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \_step_size_V[6]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \_step_size_V[7]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \_step_size_V[8]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \_step_size_V[9]_i_1\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \rdata[14]_i_1\ : label is "soft_lutpair1";
...
begin
  ...
  s_axi_AXI4LiteS_RVALID <= \FSM_sequential_rstate_reg__0\;
...
\_sine_sample_V_ap_vld_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => ar_hs,
      I2 => s_axi_AXI4LiteS_ARADDR(3),
      I3 => s_axi_AXI4LiteS_ARADDR(2),
      I4 => \_sine_sample_V_ap_vld_i_2_n_0\,
...
\_sine_sample_V_ap_vld_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
        ...
        port map (
      I0 => s_axi_AXI4LiteS_ARADDR(1),
      I1 => s_axi_AXI4LiteS_ARADDR(4),
      I2 => s_axi_AXI4LiteS_ARADDR(0),
...
\_step_size_V[15]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => s_axi_AXI4LiteS_WVALID,
      I1 => \_step_size_V[15]_i_3_n_0\,
      O => \_step_size_V0\
    );
...
\_step_size_V[15]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\rdata[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FB08"
        ...
        port map (
      I0 => p_0_in(0),
      I1 => s_axi_AXI4LiteS_ARVALID,
      I2 => \FSM_sequential_rstate_reg__0\,
      I3 => \^s_axi_axi4lites_rdata\(0),
      O => \rdata[0]_i_1_n_0\
    );
\rdata[0]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F000CA000000CA00"
        ...
        port map (
      I0 => \_sine_sample_V_ap_vld\,
      I1 => q0_reg_1(0),
      I2 => s_axi_AXI4LiteS_ARADDR(2),
      I3 => \_sine_sample_V_ap_vld_i_2_n_0\,
...
\rdata[15]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => s_axi_AXI4LiteS_ARADDR(0),
      I3 => s_axi_AXI4LiteS_ARADDR(2),
      I4 => \FSM_sequential_rstate_reg__0\,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_nco_0_0_nco_sine_lut_V_rom is
  port (
    RDEN : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_nco_0_0_nco_sine_lut_V_rom : entity is "nco_sine_lut_V_rom";
end system_nco_0_0_nco_sine_lut_V_rom;

architecture STRUCTURE of system_nco_0_0_nco_sine_lut_V_rom is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_nco_0_0_nco_sine_lut_V is
  port (
    RDEN : out STD_LOGIC;
    S : out STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_nco_0_0_nco_sine_lut_V : entity is "nco_sine_lut_V";
end system_nco_0_0_nco_sine_lut_V;

architecture STRUCTURE of system_nco_0_0_nco_sine_lut_V is
begin
nco_sine_lut_V_rom_U: entity work.system_nco_0_0_nco_sine_lut_V_rom
     port map (
      Q(15 downto 0) => Q(15 downto 0),
      RDEN => RDEN,
...
sine_lut_V_U: entity work.system_nco_0_0_nco_sine_lut_V
     port map (
      Q(15 downto 0) => Q(15 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_nco_0_0_nco_top is
  port (
    s_axi_AXI4LiteS_AWADDR : in STD_LOGIC_VECTOR ( 4 downto 0 );
    s_axi_AXI4LiteS_AWVALID : in STD_LOGIC;
  ...
  attribute C_S_AXI_AXI4LITES_ADDR_WIDTH of system_nco_0_0_nco_top : entity is 5;
  attribute C_S_AXI_AXI4LITES_DATA_WIDTH : integer;
  attribute C_S_AXI_AXI4LITES_DATA_WIDTH of system_nco_0_0_nco_top : entity is 32;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_nco_0_0_nco_top : entity is "nco_top";
  attribute RESET_ACTIVE_LOW : integer;
  attribute RESET_ACTIVE_LOW of system_nco_0_0_nco_top : entity is 1;
  attribute hls_module : string;
  attribute hls_module of system_nco_0_0_nco_top : entity is "yes";
end system_nco_0_0_nco_top;

architecture STRUCTURE of system_nco_0_0_nco_top is
  ...
  signal nco_AXI4LiteS_if_U_n_35 : STD_LOGIC;
  signal nco_AXI4LiteS_if_U_n_36 : STD_LOGIC;
  signal nco_AXI4LiteS_if_U_n_37 : STD_LOGIC;
  signal nco_AXI4LiteS_if_U_n_4 : STD_LOGIC;
...
nco_AXI4LiteS_if_U: entity work.system_nco_0_0_nco_AXI4LiteS_if
     port map (
      O(3) => nco_AXI4LiteS_if_U_n_22,
      O(2) => nco_AXI4LiteS_if_U_n_23,
      O(1) => nco_AXI4LiteS_if_U_n_24,
      O(0) => nco_AXI4LiteS_if_U_n_25,
      Q(15 downto 0) => sig_nco_step_size_V(15 downto 0),
      S(0) => nco_U_n_16,
      SR(0) => nco_AXI4LiteS_if_U_n_4,
      aclk => aclk,
      aresetn => aresetn,
      \out\(2) => s_axi_AXI4LiteS_BVALID,
      \out\(1) => s_axi_AXI4LiteS_WREADY,
      \out\(0) => s_axi_AXI4LiteS_AWREADY,
      q0_reg_1(15 downto 0) => \sine_lut_V_U/nco_sine_lut_V_rom_U/q0_reg\(15 downto 0),
      ...
      \temp_V_reg[11]\(3) => nco_AXI4LiteS_if_U_n_30,
      \temp_V_reg[11]\(2) => nco_AXI4LiteS_if_U_n_31,
      \temp_V_reg[11]\(1) => nco_AXI4LiteS_if_U_n_32,
      \temp_V_reg[11]\(0) => nco_AXI4LiteS_if_U_n_33,
      \temp_V_reg[15]\(3) => nco_AXI4LiteS_if_U_n_34,
      \temp_V_reg[15]\(2) => nco_AXI4LiteS_if_U_n_35,
      \temp_V_reg[15]\(1) => nco_AXI4LiteS_if_U_n_36,
      \temp_V_reg[15]\(0) => nco_AXI4LiteS_if_U_n_37,
      \temp_V_reg[7]\(3) => nco_AXI4LiteS_if_U_n_26,
      \temp_V_reg[7]\(2) => nco_AXI4LiteS_if_U_n_27,
      \temp_V_reg[7]\(1) => nco_AXI4LiteS_if_U_n_28,
      \temp_V_reg[7]\(0) => nco_AXI4LiteS_if_U_n_29
    );
nco_U: entity work.system_nco_0_0_nco
     port map (
      O(3) => nco_AXI4LiteS_if_U_n_22,
      O(2) => nco_AXI4LiteS_if_U_n_23,
      O(1) => nco_AXI4LiteS_if_U_n_24,
      ...
      S(0) => nco_U_n_16,
      SR(0) => nco_AXI4LiteS_if_U_n_4,
      \_step_size_V_reg[11]\(3) => nco_AXI4LiteS_if_U_n_30,
      \_step_size_V_reg[11]\(2) => nco_AXI4LiteS_if_U_n_31,
      \_step_size_V_reg[11]\(1) => nco_AXI4LiteS_if_U_n_32,
      \_step_size_V_reg[11]\(0) => nco_AXI4LiteS_if_U_n_33,
      \_step_size_V_reg[14]\(3) => nco_AXI4LiteS_if_U_n_34,
      \_step_size_V_reg[14]\(2) => nco_AXI4LiteS_if_U_n_35,
      \_step_size_V_reg[14]\(1) => nco_AXI4LiteS_if_U_n_36,
      \_step_size_V_reg[14]\(0) => nco_AXI4LiteS_if_U_n_37,
      \_step_size_V_reg[7]\(3) => nco_AXI4LiteS_if_U_n_26,
      \_step_size_V_reg[7]\(2) => nco_AXI4LiteS_if_U_n_27,
      \_step_size_V_reg[7]\(1) => nco_AXI4LiteS_if_U_n_28,
      \_step_size_V_reg[7]\(0) => nco_AXI4LiteS_if_U_n_29,
      aclk => aclk,
...
entity system_nco_0_0 is
  ...
  attribute CHECK_LICENSE_TYPE of system_nco_0_0 : entity is "system_nco_0_0,nco_top,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of system_nco_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of system_nco_0_0 : entity is "nco_top,Vivado 2018.1";
end system_nco_0_0;
...
architecture STRUCTURE of system_nco_0_0 is
  ...
  attribute X_INTERFACE_PARAMETER of aclk : signal is "XIL_INTERFACENAME aclk, ASSOCIATED_BUSIF S_AXI_AXI4LITES, ASSOCIATED_RESET aresetn, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN system_processing_system7_0_0_FCLK_CLK0";
...
begin
inst: entity work.system_nco_0_0_nco_top
     port map (
      aclk => aclk,
      aresetn => aresetn,
      s_axi_AXI4LiteS_ARADDR(4 downto 0) => s_axi_AXI4LiteS_ARADDR(4 downto 0),
